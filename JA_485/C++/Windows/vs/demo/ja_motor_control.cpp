...
:motor_id(motor_id)
{
    ...
    {
        throw runtime_error("Failed to obtain serial port parameters!");
    }
    ...
    {
        throw runtime_error("Failed to set serial port parameters!");
    }
    ...
    cout << "Serial Port " << port << " Already opened!" << endl;
}
